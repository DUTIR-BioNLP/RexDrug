#!/usr/bin/env python3
"""
Convert CoT (Chain-of-Thought) data to SFT instruction-tuning format.
...
def convert_to_sft_format(input_file: str, output_file: str) -> dict:
    """Convert CoT data to SFT format.
    ...
    with open(input_file, 'r', encoding='utf-8') as f_in, \
        ...
        for line_num, line in enumerate(f_in, 1):
            ...
            try:
                ...
                # Build assistant output (with <think> and <answer> tags, using gold standard answer)
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Convert CoT data to SFT instruction format")
    parser.add_argument(
        "--input", "-i",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output JSONL file path (default: auto-generate based on timestamp)"
    )
    ...
    if args.output is None:
        ...
        args.output = str(output_dir / f"sft_cot_drugcomb_{timestamp}.jsonl")

    print("=" * 60)
    print("CoT to SFT Data Converter")
    print("=" * 60)
