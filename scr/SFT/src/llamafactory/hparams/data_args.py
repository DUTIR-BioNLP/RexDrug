...
class DataArguments:
    ...
    # use_think_weight: bool = field(
    #     default=False,
    #     metadata={"help": "Whether to down‑weight <think> tokens (0.1) and full‑weight <answer>."}
    # )
    # think_weight: bool = field(
    #     default=0.1,
    #     metadata={"help": "down‑weight <think> tokens and full‑weight <answer>."}
    # )
    mask_think:  bool = field(
        default=False,
        metadata={"help": "Whether to mask <think> tokens ."}
    )
